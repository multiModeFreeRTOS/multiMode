...
/* The global variable for the external interrupt */
extern volatile unsigned int externalInput;
 ...
 * \ingroup Tasks
 */
#define xTaskCreate( pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pxCreatedTask, period, wcet, deadline, modeBreaks, numOfModes) xTaskGenericCreate( ( pvTaskCode ), ( pcName ), ( usStackDepth ), ( pvParameters ), ( uxPriority ), ( pxCreatedTask ), ( NULL ), ( NULL ), ( period ), (wcet) , (deadline), (modeBreaks), (numOfModes) )
#define xTaskGetDeadline( mode, pxTask) uxTaskDeadlineGet( ( mode ), ( pxTask ) )
#define xTaskGetPriority( pxTask ) uxTaskPriorityGet ( pxTask )
#define xTaskGetPeriod( mode, pxTask ) uxTaskPeriodGet ( ( mode ), ( pxTask ) )
#define xTaskGetCurMode( pxTask ) uxTaskCurrentModeGet( pxTask )
#define xTaskGetCurDeadline( mode, pxTask ) uxTaskCurrentDeadlineGet ( ( mode ), ( pxTask ) )
#define xTaskGetWCET( mode, pxTask ) uxTaskWCETGet( ( mode ), ( pxTask ))
